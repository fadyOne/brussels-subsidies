...
export default function SubsidesDashboard() {
  ...
  const [selectedDataYear, setSelectedDataYear] = useState<string>("2024")
  ...
  useEffect(() => {
    ...
    detectYears()
  }, []) // ✅ Pas de dépendance pour éviter la boucle infinie
  ...
  const totalMontant = useMemo(() => {
    // Ne compter que les subsides qui ont une catégorie claire
    return filteredSubsides
